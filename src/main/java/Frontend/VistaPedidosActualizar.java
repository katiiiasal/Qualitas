 ...
 * @author heiva
 */
public class VistaPedidosActualizar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("QUALITAS - ACTUALIZAR PEDIDOS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaPedidosActualizar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaPedidosActualizar().setVisible(true);
            }
        });
    }
